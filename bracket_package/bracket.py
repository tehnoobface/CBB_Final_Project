...
class Bracket:
    """Class to represent a tournament bracket.

    Attributes:
        teams (pd.DataFrame): DataFrame containing information about the teams.
        method (str): The ranking method used for the tournament.
        south, east, west, midwest, region_winner (pd.DataFrame): Empty DataFrames to store regional information.

    Methods:
        getData: Load tournament data from a specified dataset.
        getBracketTeams: Prompt the user to input the playoff bracket year and initialize regional teams.
        getMethod: Prompt the user to select a ranking method for the tournament.
        generateBracket: Simulate and print tournament rounds for a given region and ranking method.
        simulateOverallWinner: Simulate and print the overall winner of the tournament.
    """
    def __init__(self):
        """Initialize a Bracket object."""
    ...
    def getData(self):
        """Load tournament data from a user-specified dataset.

        Returns:
            pd.DataFrame: DataFrame containing information about the teams.
        """
        ...
        if name == 'cbb20.csv':
            ...
            teams = pd.read_csv('data/cbb21.csv')
        elif name == 'cbb22.csv':
            teams = pd.read_csv('data/cbb22.csv')
        elif name == 'cbb23.csv':
            teams = pd.read_csv('data/cbb23.csv')
        elif name == 'cbb19.csv':
            teams = pd.read_csv('data/cbb19.csv')
        else:
            print("Invalid dataset. Try again.")
            self.getData()
        data_path = pkg_resources.resource_filename('bracket_package', teams)
    ...
    def getBracketTeams(self):
        """Prompt the user to input the playoff bracket year and initialize regional teams."""
    ...
    def getMethod(self):
        """Prompt the user to select a ranking method for the tournament.

        Returns:
            str: The selected ranking method.
        """
        teams = self.teams
    ...
    def generateBracket(self, region_teams, method):
        """Simulate and print tournament rounds for a given region and ranking method.

        Args:
            region_teams (pd.DataFrame): DataFrame containing regional teams.
            method (str): The ranking method used for the tournament.
        """
    ...
    def simulateOverallWinner(self, method):
        """Simulate and print the overall winner of the tournament.

        Args:
            method (str): The ranking method used for the tournament.

        Returns:
            pd.DataFrame: The overall winner's information.
        """
        method = str(method)
...
def getPower(teams):
    """Get the 'BARTHAG' column from the teams DataFrame.

    Args:
        teams (pd.DataFrame): DataFrame containing information about the teams.

    Returns:
        str: The column name for the 'BARTHAG' values.
    """
    power = 'BARTHAG'
    #power = teams['BARTHAG']
    #print("Power test! ", end='')
...
def getRank(teams):
    """Get the 'RK' column from the teams DataFrame.

    Args:
        teams (pd.DataFrame): DataFrame containing information about the teams.

    Returns:
        str: The column name for the 'RK' values.
    """
    rank = 'RK'
    #rank = teams['RK']
    #print("Rank test! ", end='')
...
def getWins(teams):
    """Get the 'W' column from the teams DataFrame.

    Args:
        teams (pd.DataFrame): DataFrame containing information about the teams.

    Returns:
        str: The column name for the 'W' values.
    """
    wins = 'W'
    #wins = teams['W']
    #print("Win test! ", end='')
...
def getSeed(teams):
    """Get the 'SEED' column from the teams DataFrame.

    Args:
        teams (pd.DataFrame): DataFrame containing information about the teams.

    Returns:
        str: The column name for the 'SEED' values.
    """
    seed = 'SEED'
    return seed
